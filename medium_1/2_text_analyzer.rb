...
Try searching the Web for information on how to do this, 
  and also take a look at the File class in the Ruby documentation. 
  If you can't figure it out on your own, don't worry: just put the data directly into your program; 
  an Array with one element per line would be ideal.
...
analyzer.process do |text| # your implementation 
...
analyzer.process do |text| # your implementation 
  word_count = text.split(' ').count  #126 words
  # word_count = text.split(/ /).count  # 114 words
  "#{word_count} words"
end
